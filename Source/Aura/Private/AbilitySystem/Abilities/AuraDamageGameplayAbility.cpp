...
void UAuraDamageGameplayAbility::CauseDamage(AActor* TargetActor) {
  ...
  for (TTuple<FGameplayTag, FScalableFloat> Pair: DamageTypes) {
    float DamageMag = Pair.Value.GetValueAtLevel(GetAbilityLevel());
    UAbilitySystemBlueprintLibrary::AssignTagSetByCallerMagnitude(DamageSpecHandle, Pair.Key, DamageMag);
  }
